...
avg_time_query = "SELECT qset, avg(edge_read_time) FROM %s WHERE level = %s GROUP BY qset ORDER BY qset"
...
plt.tight_layout()
plt.savefig('./images/'+db+'_read_time_'+str(num_levels)+'.png', facecolor='white')